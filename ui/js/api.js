 ...
 function wsConnect() {
            ...
            mysocket.onmessage = function(msg) {
  			...
  			//displayMessage({'output': { 'text': data.d.text}},authorTypes.watson);
   			...
   			if (data.d.status.toLowerCase() == "off")
           		 Panel.meOFF('');   
           		 
           	if (data.d.status.toLowerCase() == "on")
           	{
           		
                     	if (data.d.dir.toLowerCase() == "left")
                     	 Panel.meOFF('blinkerleft');  
						
						if (data.d.dir.toLowerCase() == "right")
                     	 Panel.meOFF('blinkerright');  
